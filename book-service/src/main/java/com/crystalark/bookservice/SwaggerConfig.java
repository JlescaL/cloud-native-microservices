...
package com.crystalark.bookservice;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiMetaData() {
        ApiInfo apiInfo;
        apiInfo = new ApiInfo("Book Service",
                "Book service is one of multiple microservices in EPAM JPOP program. It provides CRUD features for a book",
