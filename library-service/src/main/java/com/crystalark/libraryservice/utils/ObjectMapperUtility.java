...
public class ObjectMapperUtility {
    ...
    /**
     * Model mapper property setting are specified in the following block. Default property matching strategy is set to
     * Strict see {@link MatchingStrategies} Custom mappings are added using
