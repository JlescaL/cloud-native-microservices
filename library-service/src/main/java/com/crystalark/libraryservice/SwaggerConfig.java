package com.crystalark.libraryservice;import org.springframework.context.annotation.Bean;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiMetaData() {
        ApiInfo apiInfo;
        apiInfo = new ApiInfo("Library Service",
                "Library service is one of multiple microservices in EPAM JPOP program. It provides CRUD features for a book",
